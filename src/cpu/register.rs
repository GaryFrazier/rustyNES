...
bitflags! {
    ...
    pub struct Status: u8 {
        ...
        const BL = 0b00010000; // break command
        const BH = 0b00100000; // break command
...
impl fmt::Display for Status {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        write!(f, "(c: {}, z: {}, i: {}, d: {}, bl: {}, bh: {}, v: {}, n: {})\n",
            ...
            (self.bits & Status::BL.bits == Status::BL.bits) as u8,
            (self.bits & Status::BH.bits == Status::BH.bits) as u8,
